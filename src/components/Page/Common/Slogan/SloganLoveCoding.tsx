...
const SloganLoveCoding: ForwardRefRenderFunction<HTMLDivElement, {}> = ({}, ref) => {
  ...
  return (
    <Space ref={ref} justify="center" aligns="middle" size={15} rootClassName={className}>
      <Paragraph size={40}>{lang.common.slogan.loveCoding.prefix}</Paragraph>
      <CiHeart size={40} />
      <Paragraph size={70} rootClassName="love-coding-suffix">{lang.common.slogan.loveCoding.suffix}</Paragraph>
    </Space>
  );
};
